...
Библиотека для работы с алгебраическими операциями над сигнатурами однородных гиперграфов произвольной степени однородности. Позволяет представлять гиперграфы через компактную сигнатурную форму и выполнять над ними теоретико-множественные и арифметические операции.
...
// Нулевой массив заданного размера и ранга
